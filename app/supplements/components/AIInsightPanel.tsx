      ...
      <Card className={`bg-gradient-to-br from-blue-50 to-indigo-50 ${className}`}>
        ...
        <CardContent>
          <p className="text-sm text-gray-600">
            No insights available at the moment. Keep tracking your supplements for personalized recommendations.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-3">
        ...
        <div className="mt-4 pt-3 border-t border-blue-200">
          <p className="text-xs text-blue-600 flex items-center gap-1">
            ...
            <span>Powered by AI analysis of your supplement patterns and performance data</span>
          </p>
        </div>
      </CardContent>
    </Card>
